...
for std in standards:
    for task_type, filename, desc, implementation in std["tasks"]:
        ...
        with open(path, "w") as f:
            ...
            f.write(
                f"**Context:** Deep Research Report Standardization (`{std['name']}`)\n\n"
            )
            f.write("## Description\n")
            f.write(f"{desc}\n\n")
