...
- An optional repository-wide `pytest tests -q` run was stopped after reaching about 4% because it extends well beyond this PR's selected gates. The observed portion reported no failure, but the full suite has no completed result.
