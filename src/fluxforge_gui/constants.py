...
GUI_PEAK_COUNTING_METHODS = ("gaussian_fit", "hypermet", "covell_local", "gilmore_minimum", "iec_tiered")
GUI_RAFM_COUNTING_METHODS = ("qg", "quantum_gold", "covell_local", "gilmore_minimum", "iec_tiered")
