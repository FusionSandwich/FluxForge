...
from fluxforge.gui.panels.modern_shell_shared import format_duration as _format_duration
from fluxforge.gui.panels.modern_shell_shared import (
...
if QT_AVAILABLE:  # pragma: no cover - optional dependency branch
    ...
    from fluxforge.gui.panels.phase5 import Phase5ParityPanel
    ...
    class BottomWorkspaceTabs(QTabWidget):
        ...
        def workflow_state(self) -> dict[str, object]:
            return {
                ...
                "phase5_parity": self.phase5_parity_panel.workflow_state(),
            }
        ...
        def apply_workflow_state(self, payload: dict[str, object] | None) -> None:
            ...
            phase5_payload = payload.get("phase5_parity")
            if isinstance(phase5_payload, dict):
                self.phase5_parity_panel.apply_workflow_state(phase5_payload)
