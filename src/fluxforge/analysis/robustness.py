...
def generate_recommendations(
    ...
    if conditioning.log_condition > 8:
        ...
        recommendations.append("Consider adding more wires to improve conditioning.")
    ...
    if critical_wires:
        ...
        recommendations.append(f"Critical wires (removal destabilizes): {names}")
