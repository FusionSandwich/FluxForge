...
class Cover:
    ...
    @classmethod
    def from_mil(
        cls, material: str, thickness_mil: float, density: Optional[float] = None
    ) -> "Cover":
...
class SampleDimensions:
    ...
    @classmethod
    def wire(
        cls, diameter_cm: float, length_cm: Optional[float] = None
    ) -> "SampleDimensions":
    ...
    @classmethod
    def wire_mil(
        cls, diameter_mil: float, length_cm: Optional[float] = None
    ) -> "SampleDimensions":
    ...
    @classmethod
    def foil(
        cls, thickness_cm: float, width_cm: float, height_cm: float
    ) -> "SampleDimensions":
    ...
    @classmethod
    def foil_mil(
        cls, thickness_mil: float, width_cm: float, height_cm: float
    ) -> "SampleDimensions":
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "dimensions": (
                {
                    "diameter_cm": (
                        self.dimensions.diameter_cm if self.dimensions else None
                    ),
                    "thickness_cm": (
                        self.dimensions.thickness_cm if self.dimensions else None
                    ),
            ...
            "composition": [
                {"nuclide": c.nuclide, "atom_fraction": c.atom_fraction}
