...
class TestLethargyCorrectedCovariance:
    ...
    def test_is_symmetric(self):
        ...
        V = create_lethargy_correlated_covariance(prior_flux, energy_bounds, 0.25, 1.0)
...
class TestPriorCovarianceConfig:
    ...
    def test_build_diagonal(self):
        ...
        config = PriorCovarianceConfig(
            model_type=PriorCovarianceModel.DIAGONAL, fractional_uncertainty=0.20
        )
    ...
    def test_user_supplied(self):
        ...
        config = PriorCovarianceConfig(
            model_type=PriorCovarianceModel.USER_SUPPLIED, user_covariance=user_cov
        )
...
class TestResponseUncertaintyConfig:
    ...
    def test_ignore_policy(self):
        ...
        config = ResponseUncertaintyConfig(policy=ResponseUncertaintyPolicy.IGNORE)
