...
class TestCoverConfiguration:
    ...
    def test_default_properties(self):
        ...
        config = CoverConfiguration(material=CoverMaterial.CADMIUM, thickness_cm=0.1)
    ...
    def test_custom_properties(self):
        ...
        config = CoverConfiguration(
            material=CoverMaterial.CADMIUM, thickness_cm=0.1, custom_properties=custom
        )
...
class TestCoverCorrectionGroup:
    ...
    def test_thermal_group_cd(self):
        ...
        cover = CoverConfiguration(
            material=CoverMaterial.CADMIUM, thickness_cm=0.1  # 1 mm
        )
    ...
    def test_fast_group_cd(self):
        ...
        cover = CoverConfiguration(material=CoverMaterial.CADMIUM, thickness_cm=0.1)
...
class TestCCFComputation:
    ...
    def test_ccf_beam_vs_isotropic(self):
        ...
        cover_thin = CoverSpec(
            thickness_mil=1.0, angular_model=FluxAngularModel.ISOTROPIC
        )
...
class TestEnergyDependentCoverResult:
    ...
    def test_compute_all_groups(self):
        ...
        result = compute_energy_dependent_cover_corrections(cover, bounds, sigma_t)
