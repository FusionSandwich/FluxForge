...
class TestN42NumericTextParsing:
    """Tests for whitespace/comma separated numeric token parsing."""

    def test_parse_numeric_values_whitespace_and_commas(self):
        parsed = _parse_numeric_values("1, 2  3\n4")
        assert parsed == [1.0, 2.0, 3.0, 4.0]

    def test_parse_numeric_values_invalid_returns_none(self):
        assert _parse_numeric_values("1 two 3") is None
