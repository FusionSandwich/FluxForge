...
def test_semi_empirical_efficiency_matches_reference_example():
...
def test_semi_empirical_efficiency_uncertainty_matches_reference_example():
    energies = 50.0 * np.arange(1, 10)
    coeffs = [0.02, 8.3, 2.1, 1.66, 0.4]
    covariance = np.array(
        [
...
def test_resolution_linear_matches_reference_example():
...
def test_attenuation_stack_matches_reference_example():
