...
def main() -> None:
    ...
    ref_path = output_dir / "pygammaspec_reference_peaks.json"
    ff_path = output_dir / "pygammaspec_peaks.json"
    ...
    with (output_dir / "pygammaspec_peak_comparison.csv").open("w", newline="", encoding="utf-8") as handle:
